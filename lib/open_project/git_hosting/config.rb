module OpenProject::GitHosting
  module Config
    ...
    GITHUB_ISSUE = 'https://github.com/jbox-web/openproject_git_hosting/issues'
    GITHUB_WIKI  = 'https://github.com/jbox-web/openproject_git_hosting/wiki/Configuration-variables'
    ...
    def self.get_scripts_dir_path
      if @@previous_scripts_dir_path != gitolite_scripts_dir
        ...
        if gitolite_scripts_dir[0, 1] == "/"
          ...
          @@scripts_dir_path = Rails.root.join("plugins/openproject_git_hosting", gitolite_scripts_dir, GITOLITE_SCRIPTS_PARENT_DIR).to_s + "/"
        end
      end
